...
def create_annotation(question_id, answer_id, annotation, position):
    return Annotation.objects.create(question_id=question_id, answer_id=answer_id, annotation=annotation, position=position)
...
class AnnotationTests(TestCase):
    ...
    def test_get_annotation_by_question(self):
        ...
        self.assertEqual(response.content, '[{"question_id":1,"answer_id":1,"annotation":"https://www.youtube.com/watch?v=0MjdyurrP6c","position":7}]')
    ...
    def test_get_annotation_by_answer(self):
        ...
        #print(response)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.content, '[{"question_id":2,"answer_id":1,"annotation":"https://www.youtube.com/watch?v=g7zO1MBu8SQ","position":3}]')
    ...
    def test_get_annotation_by_url(self):
        ...
        response = client.get('/api/annotator/annotation?pk=2', format='json')
        #print(response)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.content, '[{"question_id":2,"answer_id":1,"annotation":"https://www.youtube.com/watch?v=g7zO1MBu8SQ","position":3}]')
    ...
    def test_post_annotation(self):
        ...
        """
        client = APIClient()
        data = {"question_id":5, "answer_id":10, "annotation":"https://www.youtube.com/watch?v=0MjdyurrP6c","position":15}
        response = client.post('/api/annotator/annotation/', data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(response.content, '{"question_id":5,"answer_id":10,"annotation":"https://www.youtube.com/watch?v=0MjdyurrP6c","position":15}')

        data = {"question_id":5, "answer_id":10,"position":15}
        response = client.post('/api/annotator/annotation/', data, format='json')
        print(response.content)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)      
        self.assertEqual(response.content, '{"question_id":5,"answer_id":10,"annotation":"","position":15}')
    ...
    def test_get_multiple_annotation_by_question(self):
        ...
        #print(response.content)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.content, '[{"question_id":1,"answer_id":1,"annotation":"https://www.youtube.com/watch?v=0MjdyurrP6c","position":7},{"question_id":1,"answer_id":2,"annotation":"https://www.youtube.com/watch?v=3BxYqjzMz-U","position":12}]')
    ...
    def test_get_fail_annotation_url(self):
        ...
        client = APIClient()
        create_annotation(1, 3, "https://www.youtube.com/watch?v=3BxYqjzMz-U", 10)
        response = client.get('/api/annotator/annotation?pk=9000', format='json')
        #print(response.status_code)
        #print(response)
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
